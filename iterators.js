 ...
 ***************************************/
const hottestDays = (temperatures, threshhold) => temperatures.filter(t => t > threshhold)
...
const logHottestDays = (temperatures, threshhold) => {
    ...
    //do it in more than one line
    // let t = hottestDays(temperatures, threshhold);
    // let a = toCelsius(t);
    // logger(a);
